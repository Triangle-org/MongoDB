...
namespace Triangle\MongoDB\Query;
...
class Builder extends BaseBuilder
{
     ...
     */
    public function getFresh(array $columns = [], bool $returnLazy = false): Collection|LazyCollection
    {
     ...
     * @inheritdoc
     */
    public function distinct($column = false): Builder|BaseBuilder|static
    {
        $this->distinct = true;
     ...
     * @inheritdoc
     */
    public function orderBy($column, $direction = 'asc'): Builder|BaseBuilder|static
    {
     ...
     * @return $this
     */
    public function whereAll(string $column, array $values, string $boolean = 'and', bool $not = false): static
    {
        $type = 'all';
     ...
     * @inheritdoc
     */
    public function whereBetween($column, array $values, $boolean = 'and', $not = false): Builder|BaseBuilder|static
    {
        $type = 'between';
     ...
     * @inheritdoc
     */
    public function forPage($page, $perPage = 15): Builder|BaseBuilder
    {
